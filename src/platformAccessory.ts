...
export class SonosSoundFeaturesAccessory {
  ...
  constructor(
    ...
    if (info.supportsNightMode) {
      ...
      this.nightModeService.setCharacteristic(this.platform.Characteristic.Name, 'Night Mode');
      this.nightModeService.setCharacteristic(this.platform.Characteristic.ConfiguredName, 'Night Mode');
    ...
    if (info.supportsSpeechEnhancement) {
      ...
      this.speechEnhancementService.setCharacteristic(this.platform.Characteristic.Name, 'Speech Enhancement');
      this.speechEnhancementService.setCharacteristic(this.platform.Characteristic.ConfiguredName, 'Speech Enhancement');
